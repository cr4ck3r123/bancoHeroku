...
public class Mapa extends MapView {
     ...
     */
    public Mapa(String pString, double lat, double lng) {

        JFrame frame = new JFrame("Foz do Iguaçu - Paraná: "+ pString);
        ...
        setOnMapReadyHandler(new MapReadyHandler() {
            ...
            public void onMapReady(MapStatus status) {
                ...
                //    controlOptions.setPosition(ControlPosition.BOTTOM_LEFT);
                    options.setApiKey("AIzaSyDZL37hvqGfIKRTun_KQ6uzt0SpuFRKJos");
        ...
        System.out.print("Aguarde enquanto o mapa e carregado");
    ...
    public static void main(String[] args) {
       ...
       final Mapa example = new Mapa("Foz", -25.4367565, -49.259504);
